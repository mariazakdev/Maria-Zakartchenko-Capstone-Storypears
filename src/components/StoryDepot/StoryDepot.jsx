    ...
    <ShuffleArray items={filteredStories}>
      {(shuffledStories) => (
        <div className="story-depot">
          <GenreFilter genres={genres} onGenreSelect={handleGenreSelect} className="story-depot__genre-filter" />
          <EmotionsFilter emotions={emotions} onEmotionSelect={handleEmotionSelect} className="story-depot__emotion-filter" />
