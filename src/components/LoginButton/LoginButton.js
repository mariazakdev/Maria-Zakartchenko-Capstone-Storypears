...
const LoginButton = () => {
  return (
    // The link will take user to `http://localhost:5050/auth/github` 
    // which starts the authentication process with GitHub, just like we were testing on the server side
